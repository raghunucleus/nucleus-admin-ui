  ...
  return (
    ...
    >
      <table
        data-slot="table"
        className={cn(
          // min-w-full lets the table fill the container at the minimum,
          // but grow beyond it when columns' nowrap content demands more
          // — that triggers the container's horizontal scroll.
...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "h-10 px-4 text-left align-middle text-xs font-medium uppercase tracking-wide text-muted-foreground whitespace-nowrap bg-muted",
